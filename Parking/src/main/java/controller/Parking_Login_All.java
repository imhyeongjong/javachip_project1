...
@WebServlet("/Parking_Login_All")
public class Parking_Login_All extends HttpServlet {
	...
	request.setCharacterEncoding("UTF-8");
		...
		if (loginParking != null) {
			...
			response.sendRedirect("./ParkingAll.jsp");
		} else {
			System.out.println("로그인 실패...");
			response.sendRedirect("./PakringloginAll.jsp");
		}
	}
