...
//현재위치 가져오기 //////
	...
	mapOption = { 
	    center: new kakao.maps.LatLng(35.14984571695584, 126.91204540057561), // 지도의 중심좌표
	    level: 3 // 지도의 확대 레벨 
	}; 
	...
	var locPosition = new kakao.maps.LatLng(35.14984571695584, 126.91204540057561),    
...
function getListItem(index, places) {
    ...
    var el = document.createElement('li'), // 주차장 이름
    itemStr = '<span class="markerbg marker_' + (index+1) + '"></span>' +
                '<div class="info">' +
                '<h5><a href = "./test.html">' + places.place_name + '</a></h5>';
...
function addMarker(position, idx, title) {
    var imageSrc = 'https://ifh.cc/g/jmmkTQ.png', // 마커 이미지 url, 스프라이트 이미지를 씁니다
