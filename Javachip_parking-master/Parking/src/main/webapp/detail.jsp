            ...
            <div class="container">
                <div class="progress-container">
                    <div class="progress-bar">
                        ...
                        <div class="progress-bar-text">"주차자리 간격이 넓어요"+<%= review.getR_1() %></div>
                ...
                <div class="progress-container">
                    <div class="progress-bar">
                        ...
                        <div class="progress-bar-text">"가격이 합리적이에요"+<%= review.getR_2() %></div>
                ...
                <div class="progress-container">
                    <div class="progress-bar">
                        ...
                        <div class="progress-bar-text">"관리인이 친절해요"+<%= review.getR_3() %></div>
                ...
                <div class="progress-container">
                    <div class="progress-bar">
                        ...
                        <div class="progress-bar-text">"발렛파킹이 가능해요"+<%= review.getR_4() %></div>
                ...
                <div class="progress-container">
                    <div class="progress-bar">
                        ...
                        <div class="progress-bar-text">"그늘막이 있어요"+<%= review.getR_5() %></div>
